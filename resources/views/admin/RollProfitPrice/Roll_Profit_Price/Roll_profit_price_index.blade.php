                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Product\Roll_profit_price_Controller@getCreate') }}"><span class="btn btn-primary btn-xs" style="margin-right: 15px;"> <i class="fa fa-plus"></i> {{ trans('dashboard.add') }}</span></a>
                                     ...
                                     <table class="table table-striped table-hover" id="profit-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="no-sort hidden-sm-down">{{ trans('dashboard.profit_kg')}}</th> 
...
$(function() {
            ...
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\Roll_profit_price_Controller@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
                { data: 'from_kg', name: 'from_kg' },
                { data: 'to_kg', name: 'to_kg' },
                { data: 'profit_kg', name: 'profit_kg'},
