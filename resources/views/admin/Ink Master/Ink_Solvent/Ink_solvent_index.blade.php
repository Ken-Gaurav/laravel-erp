...
@section('header')
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-list"></i> {{ trans('dashboard.ink_solvent') }}</h3>
            <ol class="breadcrumb">
                <li>
                ...
                <li>
                    ...
                    <a ><span class="nav-label">{{ trans('dashboard.ink_solvent_list') }}</span></a>
                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Ink Solvent Listing</h5>

                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Product\Ink_solventController@getCreate') }}"><span class="btn btn-primary btn-xs" style="margin-right: 15px;"> <i class="fa fa-plus"></i> Add</span></a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form id="frmFilter">
                                     ...
                                     <table class="table table-striped table-hover" id="ink-table">
                                        <thead>
                                            <tr>
                                                <th class="no-sort hidden-sm-down">Price</th>
...
$(function() {
            ...
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\Ink_solventController@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [                
    ...
    $(document).on('click','#ac', function(e) {
        ...
        var ink_solvent_id = $(this).attr('data-id');       
        ...
        var self = this;
            if (confirm("Are you sure Status changed!")) {
                ...
                $.ajax({
                    "url": '{!! action("Admin\Product\Ink_solventController@anyStatuschange") !!}',
                    async: false,
                    data: {ink_solvent_id: ink_solvent_id, status: status},
                    method: 'GET',
