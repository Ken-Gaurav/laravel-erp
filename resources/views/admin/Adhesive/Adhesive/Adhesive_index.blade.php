...
@section('header')
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-list"></i> {{ trans('dashboard.adhesive') }}</h3>
            <ol class="breadcrumb">
                <li>
                ...
                <li>
                    ...
                    <a ><span class="nav-label">{{ trans('dashboard.adhesive_list') }}</span></a>
                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>{{ trans('dashboard.adhesive_listing') }}</h5>

                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Product\AdhesiveController@getCreate') }}"><span class="btn btn-primary btn-xs" style="margin-right: 15px;"> <i class="fa fa-plus"></i> Add</span></a>
                                </div> 
...
$(function() {
            ...
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\AdhesiveController@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
    ...
    $(document).on('click','#ac', function(e) {
        ...
        var adhesive_id = $(this).attr('data-id');       
        ...
        var self = this;
            if (confirm("Are you sure Status changed!")) {
                ...
                $.ajax({
                    "url": '{!! action("Admin\Product\AdhesiveController@anyStatuschange") !!}',
                    async: false,
                    data: {adhesive_id: adhesive_id, status: status},
                    method: 'GET',
