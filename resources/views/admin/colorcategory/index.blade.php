...
@section('header')
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-list"></i> {{ trans('dashboard.color_category') }}</h3>          
            <ol class="breadcrumb">
                <li>
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    ...
                                    <form id="frmFilter">
                                     ...
                                     <table class="table table-striped table-hover" id="colorTable" style="background-color: #245f4c1f;">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" id="chk"></th>
                                                <th class="no-sort">{{ trans('dashboard.color') }}</th>
                                                <th class="no-sort">{{ trans('dashboard.status') }}</th> 
                                                <th class="no-sort">{{ trans('dashboard.action') }}</th>                                                
                                            </tr>
                                        </thead>
