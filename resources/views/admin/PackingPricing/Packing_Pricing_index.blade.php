                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Product\Packing_PricingController@getCreate') }}"><span class="btn btn-primary btn-xs" style="margin-right: 15px;"> <i class="fa fa-plus"></i> {{ trans('dashboard.add') }}</span></a>
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    ...
                                    <form id="frmFilter">
                                     ...
                                     <table class="table table-striped table-hover" id="packingpricing-table">
                                        <thead>
                                            <tr>
                                                <th class="no-sort hidden-sm-down">{{ trans('dashboard.from_total') }}</th>
                                                <th class="no-sort hidden-sm-down">{{ trans('dashboard.to_total') }}</th>
...
$(function() {
            $dataTable = $('#packingpricing-table').DataTable({
            processing: true,
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\Packing_PricingController@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
                { data: 'from_total', name: 'from_total' },
                { data: 'to_total', name: 'to_total' },
