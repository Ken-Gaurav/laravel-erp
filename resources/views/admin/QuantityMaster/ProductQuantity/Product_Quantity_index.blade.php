...
@section('header')
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-list"></i> {{ trans('dashboard.product_quantity') }}</h3>
            <ol class="breadcrumb">
                <li>
                ...
                <li>
                    ...
                    <a ><span class="nav-label">{{ trans('dashboard.product_quantity_list') }}</span></a>
                </li>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Product\Product_QuantityController@getCreate') }}"><span class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>{{ trans('dashboard.add') }}</span></a>
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    ...
                                    <form id="frmFilter">
                                     ...
                                     <table class="table table-striped table-hover" id="productquantity-table">
                                        <thead>
                                            <tr>
  ...
  $('.delete_all').on('click', function(e)
     {
        ...
        {  
            ...
            if(check == true){ 
                ...
                $.ajax({
                    "url": '{!! action("Admin\Product\Product_QuantityController@getRemove")!!}',                        
                    async: false,
                    ...
                    success: function (data) {
                        ...
                        if (data['success']) {
                            ...
                            $('#productquantity-table').DataTable().draw();                            
 ...
 $('.inactive_all').on('click',function(e){
        ...
        {  
            ...
            if (confirm("Are you sure Status changed!")) {
                    $.ajax({
                        "url": '{!! action("Admin\Product\Product_QuantityController@getInactiveall") !!}',
                        async: false,
                        data: {ids: join_selected_values, status: status},
                        method: 'GET',
                        success: function (data) {
...
//                                 next();
 ...
 $('.active_all').on('click',function(e){
        ...
        {  
            ...
            if (confirm("Are you sure Status changed!")) {
                    $.ajax({
                        "url": '{!! action("Admin\Product\Product_QuantityController@getActiveall") !!}',
                        async: false,
                        data: {ids: join_selected_values, status: status},
                        method: 'GET',
                        success: function (data) {
...
$(function() {
            $dataTable = $('#productquantity-table').DataTable({
            processing: true,
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\Product_QuantityController@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
                { data: 'product_quantity_id', name: 'product_quantity_id', orderable: false, searchable: false },
...
var product_quantity_id = $(this).attr('data-id');       
...
var self = this;
    if (confirm("Are you sure Status changed!")) {
        ...
        $.ajax({
            "url": '{!! action("Admin\Product\Product_QuantityController@anyStatuschange") !!}',
            async: false,
            data: {product_quantity_id: product_quantity_id, status: status},
            method: 'GET',
