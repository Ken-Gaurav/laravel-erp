        ...
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    ...
                    <a ><span class="nav-label">{{ trans('dashboard.s_p_f_list') }}</span></a>
                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2>Stock Profit By Pickup Details</h2>
...
$(function() {
            ...
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\stock_profit_pickup_controller@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
