...
@section('header')
     <div class="row">
        <div class="col-lg-12">
         <h3><i class="fa fa-home"></i> {{ trans('dashboard.dashboard') }}</h3>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content no-padding">
                        <div class="flot-chart m-t-lg" style="height: 55px;">
                            <div class="flot-chart-content" id="flot-chart1" style="padding: 0px; position: relative;"><canvas class="flot-base" width="418" height="55" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 418px; height: 55px;"></canvas><canvas class="flot-overlay" width="418" height="55" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 418px; height: 55px;"></canvas></div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
                                        <canvas id="lineChart" height="205" width="540" style="display: block; width: 540px; height: 205px;"></canvas>
                                    </div>
                                </div>
                                <div class="col-md-4">
